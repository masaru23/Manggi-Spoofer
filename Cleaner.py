...
image_chill = ("C:\\ManggiSpoofer\\")
file = pathlib.Path("C:\\ManggiSpoofer\\")
if file.exists ():
    print ("File exist")
else:
...
pic = pathlib.Path('C:\\ManggiSpoofer\\Manggi.jpg')
if pic.exists():
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")), size=(26, 26))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")), size=(330, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")), size=(20, 20))
        self.home_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")),
                                                 dark_image=Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")), size=(20, 20))
        self.chat_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")),
                                                 dark_image=Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")), size=(20, 20))
        self.add_user_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")),
                                                     dark_image=Image.open(os.path.join(image_path, "C:\ManggiSpoofer\Manggi.jpg")), size=(20, 20))
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  MANGGI KA BA?", image=self.logo_image,
        ...
        self.appearance_mode_menu = customtkinter.CTkOptionMenu(self.navigation_frame, values=["Light", "Dark", "System"],
                                                                command=self.change_appearance_mode_event, fg_color="#de0000", dropdown_fg_color="#de0000", button_color="#de0000")
        ...
        self.home_frame_button_1 = customtkinter.CTkButton(self.home_frame, text="Rename Discord_RPC", compound="right", command=discorddll, fg_color="#de0000", border_width=2, border_color="#910000", hover_color="#212121")
        self.home_frame_button_1.grid(row=1, column=0, padx=20, pady=10)
        self.home_frame_button_2 = customtkinter.CTkButton(self.home_frame, text="Cache Delete",  compound="right", command=cache, fg_color="#de0000", border_width=2, border_color="#910000", hover_color="#212121")
        self.home_frame_button_2.grid(row=2, column=0, padx=20, pady=10)
        self.home_frame_button_3 = customtkinter.CTkButton(self.home_frame, text="Block Xbox",  compound="right", command=xbox, fg_color="#de0000", border_width=2, border_color="#910000", hover_color="#212121")
        self.home_frame_button_3.grid(row=3, column=0, padx=20, pady=10)
        self.home_frame_button_4 = customtkinter.CTkButton(self.home_frame, text="Spoof", compound="bottom", command=delete, fg_color="#de0000", border_width=2, border_color="#910000", hover_color="#212121")
        self.home_frame_button_4.grid(row=4, column=0, padx=20, pady=10)

        # create second frame
        self.second_frame = customtkinter.CTkFrame(self, corner_radius=0, fg_color="transparent")
        self.second_frame_button_5 = customtkinter.CTkButton(self.second_frame, text="MANGGI MADE THIS...\n\n the best free cleaner :)\n Not sure how to unban yourself?\nclick on the disocrd tab\nclick the discord button and you will be invited to the server.\n or if you wish go to my github and find the server link there.", compound="right",)
...
def xbox():
    ...
    try:
        if os.path.exists(file_path):
            ...
            print("Granted Read and Write Perms")
        else:
            print("File not found:", file_path)
    except PermissionError:
            print("Perms Denied. You don't have necessary permissions to change the permissions of this file")
                
    with open(file_path, "a") as file:
       file.write('#	127.0.0.1 xboxlive.com\n')
       file.write('#	127.0.0.1 user.auth.xboxlive.com\n')
       file.write('#	127.0.0.1 presence-heartbeat.xboxlive.com\n')
    print("File modified")
   # f = open(file_path, 'a')
